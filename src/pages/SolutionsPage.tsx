...
export default function SolutionsPage() {
  ...
  return (
    <Layout>
      ...
      {solutions.map((sol, i) => {
        const isEven = i % 2 === 0;
        // LTR: even→img start, odd→img end | RTL: flipped
        ...
        return (
          <section key={sol.id} id={sol.id} className="border-b border-border" dir={isAr ? "rtl" : "ltr"}>
            <div className="grid md:grid-cols-2">
              {/* Image */}
              <div className={`relative overflow-hidden ${imgOrder}`} style={{ minHeight: "280px" }}>
                <img
                  src={sol.image}
                  alt={sol.title}
                  loading="lazy"
              ...
              >
                ...
                >
                  {isAr ? "حل " : "The "}
                  <span style={{ color: "hsl(var(--primary))" }}>{sol.title}</span>
                </h2>
            ...
            <Reveal>
              ...
              >
                {[
                  ...
                  <div key={j} className={`py-6 px-7 ${j < 2 ? "border-e border-border" : ""}`}>
                    <span
          ...
          <div className="industrial-container" dir={isAr ? "rtl" : "ltr"}>
            <Reveal className="mb-8">
              <div className="flex items-end justify-between">
                ...
                <Link
                  to="/shop"
                  className="inline-flex items-center gap-1.5 font-mono text-[0.58rem] uppercase tracking-[0.18em] hover:text-primary transition-colors shrink-0"
