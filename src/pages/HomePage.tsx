      ...
      <section className="relative min-h-screen flex items-end overflow-hidden pb-24 md:pb-32">
        ...
        <div className="industrial-container relative z-10">
          <div className="max-w-4xl rtl:text-right">
            {/* Eyebrow */}
            <div className="flex items-center gap-2.5 mb-5 rtl:flex-row-reverse rtl:justify-end">
              <span
                style={{
                  width: "1.2rem",
                  height: "1.5px",
            ...
            {/* Title */}
            <h1 className="text-3xl md:text-5xl font-bold uppercase tracking-tighter leading-tight text-background mb-8 animate-industrial-fade">
              {t("hero.title")}
              <span className="block text-primary">{t("hero.titleHighlight")}</span>
            </h1>

            {/* 3 statement lines */}
            <div className="space-y-0 mb-10 animate-industrial-fade">
              {[t("hero.line1"), t("hero.line2"), t("hero.line3")].map((line, i) => (
                <div
                  key={i}
                  className="flex items-start gap-3 py-3 border-b rtl:flex-row-reverse"
            ...
            {/* CTAs */}
            <div className="flex flex-col sm:flex-row gap-4 animate-industrial-fade delay-300 rtl:sm:flex-row-reverse">
