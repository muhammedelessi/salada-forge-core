...
• بموافقتك`,
    ...
    terms: {
      ...
      sections: [
        {
          title: 'قبول الشروط',
          content: `بالوصول إلى موقع صالدة واستخدام خدماتنا، فإنك تقبل وتوافق على الالتزام بهذه الشروط والأحكام. إذا كنت لا توافق على هذه الشروط، يرجى عدم استخدام خدماتنا.`,
        },
        {
        ...
        },
        {
          ...
          content: `أوقات التوصيل تقديرية فقط وغير مضمونة. صالدة غير مسؤولة عن التأخيرات الناجمة عن شركات الشحن أو الجمارك أو عوامل أخرى خارجة عن سيطرتنا. ينتقل الملكية ومخاطر الخسارة إليك عند التسليم للناقل.`,
        },
        {
          title: 'حدود المسؤولية',
          content: `لن تكون صالدة مسؤولة عن أي أضرار غير مباشرة أو عرضية أو خاصة أو تبعية أو عقابية ناشئة عن استخدامك لمنتجاتنا أو خدماتنا. لن تتجاوز مسؤوليتنا الإجمالية المبلغ الذي دفعته للمنتج المحدد الذي أدى إلى المطالبة.`,
        },
        {
