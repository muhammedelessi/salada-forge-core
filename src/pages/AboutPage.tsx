    ...
    <Layout>
      ...
      <section className="relative overflow-hidden py-32 md:py-48">
        ...
        <div className="industrial-container relative z-10">
          <div className={`max-w-3xl ${isAr ? "text-right ml-auto mr-0" : ""}`}>
            ...
            <h1
              className="font-black uppercase leading-[0.92] tracking-[-0.03em] mb-6 animate-fade-up delay-400"
            ...
            {/* description */}
            <p
              className="text-sm md:text-base leading-relaxed max-w-xl mb-8 animate-fade-up delay-500"
      ...
      <section className="bg-background border-b border-border py-20 md:py-32">
        <div className="industrial-container">
          <div className={`grid md:grid-cols-2 gap-14 md:gap-24 items-start ${isAr ? "text-right" : ""}`}>
            <Reveal>
            ...
            <Reveal delay={150}>
              <div className="grid grid-cols-2 gap-px" style={{ background: "hsl(var(--border))" }}>
                {factoryStats.map((s, i) => (
                  <div
                    key={i}
                    className="bg-background p-7 hover:bg-secondary/40 transition-colors duration-200"
      ...
      ════════════════════════════════ */}
      <section className="bg-secondary/30 border-b border-border py-20 md:py-32">
        <div className="industrial-container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px" style={{ background: "hsl(var(--border))" }}>
            {pillars.map((p, i) => (
              <Reveal key={p.num} delay={i * 80}>
                <div
                  className="bg-background p-8 md:p-10 h-full group hover:bg-primary/5 transition-colors duration-300"
                  style={{ background: "hsl(var(--background))" }}
                >
                  {/* number */}
                  <div
                    className="font-mono font-black leading-none mb-5"
                    style={{ fontSize: "2.5rem", color: "hsl(var(--primary))", opacity: 0.55 }}
                  >
                    {p.num}
                  </div>
      ...
      <section className="bg-background border-b border-border py-20 md:py-32">
        <div className="industrial-container">
          <div className={`grid md:grid-cols-2 gap-12 md:gap-20 items-center ${isAr ? "text-right" : ""}`}>
            {/* Text */}
