  ...
  if (path === '/faq') {
    return {
      ...
      "mainEntity": [
        ...
        { "@type": "Question", "name": "Are your containers certified?", "acceptedAnswer": { "@type": "Answer", "text": "Yes, all our containers meet international standards. Our offshore containers are DNV 2.7-1 certified, and all products comply with relevant industry regulations." } },
...
export function SEOHead({ title, description, path }: SEOHeadProps) {
  ...
  return (
    <Helmet>
      ...
      <meta property="og:image:alt" content="Salada — Saudi Manufacturer of Industrial Containers, Shipping & Storage Solutions, and Container Parts & Securing Equipment" />
