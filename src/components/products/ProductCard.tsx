  ...
  if (variant === "compact") {
    return (
      ...
      >
        ...
        >
          <span
            className="block font-mono text-[0.65rem] uppercase tracking-[0.2em] mb-1"
    ...
    <div className="group border border-border bg-background transition-all duration-300 hover:border-primary">
      ...
      <Link to={`/product/${product.slug}`} className="block relative overflow-hidden">
        ...
        {product.status === "out_of_stock" && (
          <div
            className={cn(
              "absolute top-3 font-mono text-[0.65rem] uppercase tracking-[0.2em] px-2.5 py-1 bg-destructive text-destructive-foreground",
              isAr ? "right-3" : "left-3",
            )}
          >
            {t.product.outOfStock}
        ...
        >
          <Link
            ...
            className={cn(
              ...
              "font-mono text-[0.65rem] uppercase tracking-[0.18em] font-700",
